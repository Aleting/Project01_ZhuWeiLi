            ...
            <div class="row placeholders">
                ...
                <table class="table table-hover table-bordered user-list">
                    ...
                    <c:forEach items="${clerkList }" var="clerk">
                        <tr>
                            <td><input type="checkbox" name="clerk_id" value="${clerk.sellerId }"/></td>

                            <td class="username">${clerk.sellerLoginName }</td>
                            ...
                            <td>
                                <a class="glyphicon glyphicon-wrench show-userrole-form" aria-hidden="true" title="修改店员权限" href="${pageContext.request.contextPath}/clerk/queryClerkPermission?clerk_id=${clerk.sellerId}&store_id=${clerk.storeId}" ></a>
                                &nbsp;&nbsp;<a class="glyphicon glyphicon-remove delete-this-user" aria-hidden="true" title="删除用户" href="javascript:void(0);" onclick="onDel(${clerk.sellerId })"></a>
                            </td>
